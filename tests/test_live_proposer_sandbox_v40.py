...
class TestLiveProposerSandboxV40(unittest.TestCase):
    def test_live_proposer_sandbox_gates(self):
        subprocess.run(
            [sys.executable, "scripts/v4_0/run_live_proposer_sandbox_v40.py"],
            cwd=ROOT,
            check=True,
        )
