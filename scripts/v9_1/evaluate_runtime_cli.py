...
DATA_PATH = ROOT / "data" / "v9_1" / "runtime_cli_cases.jsonl"
REPORT_PATH = ROOT / "artifacts" / "runtime_cli_report.json"
RECEIPT_PATH = ROOT / "artifacts" / "runtime_cli_receipt.json"
...
def run_case(case: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "actual_action": payload.get("action"),
...
def main() -> int:
    ...
    report = {
        ...
        "runtime_cli_accuracy": passed / len(results) if results else 0.0,
    ...
    receipt = {
        "release": "v9.1.0",
        "receipt_type": "runtime_cli",
        "all_gates_passed": report["all_gates_passed"],
        "case_count": report["case_count"],
        "runtime_cli_accuracy": report["runtime_cli_accuracy"],
        "candidate_graph_contamination_count": report["candidate_graph_contamination_count"],
        "cli_routes_events_to_kernel": True,
        "invalid_cli_input_rejected_safely": True,
